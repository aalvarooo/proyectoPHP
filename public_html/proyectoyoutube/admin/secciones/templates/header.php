<?php
$url_base="https://amateos.tible.tech/proyectoyoutube/admin/";
    ...
    <header>
        ...
        <nav class="navbar navbar-expand navbar-light bg-light">
            ...
            <div class="nav navbar-nav">
                ...
                <a class="nav-item nav-link active" href="<?php echo $url_base;?>secciones/servicios/" aria-current="page">Administrador</a>
